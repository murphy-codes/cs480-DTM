...
//This activity will prompt the user to click the "Ask" button to record audio,
//  then launch MovieLookup.java on "Don't Tell Me" press.
...
public class VoiceInput extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = " com.kinne.jack.websearchapi.MESSAGE";
